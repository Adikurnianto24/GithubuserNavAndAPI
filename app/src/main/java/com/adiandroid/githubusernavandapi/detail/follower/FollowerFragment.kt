...
class FollowerFragment : Fragment(R.layout.userfollow_fragment) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.listFollowers.observe(viewLifecycleOwner) { followers ->
            if (followers.isNullOrEmpty()) {
                ...
                binding.imageViewNoFollower.visibility = View.VISIBLE
            } else {
                binding.userRv.visibility = View.VISIBLE
                binding.imageViewNoFollower.visibility = View.GONE
        ...
        viewModel.setListFollowers(username) { message ->
